...
gcloud firebase test android run --type instrumentation \
  --app ../dashboard/build/app/outputs/apk/development/debug/app-development-debug.apk \
  --test ../dashboard/build/app/outputs/apk/androidTest/development/debug/app-development-debug-androidTest.apk \
  --device-ids=redfin \
  --os-version-ids=30 \
  --locales=en_GB \
