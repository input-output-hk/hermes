...
# -xctestrun "../dashboard/build/ios_integ/Build/Products/development_iphoneos17.0-arm64.xctestrun" \
...
gcloud firebase test ios run \
  --test "../dashboard/build/ios_integ/Build/Products/ios_tests.zip" \
