...
get-local-athena:
    ...
    earthly ./hermes/apps/athena/modules+local-build-voting-index
    ...
    target/release/hermes module package hermes/apps/athena/modules/voting-index/lib/manifest_module.json
